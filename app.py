...
# Add the 'Comprimé' column back to the pivot table
pivot_table_profile_forme['Comprimé'] = 0  # Assuming a default value of 0 for 'Comprimé'
...
st.write("## Reverted Pivot Table with 'Comprimé'")
